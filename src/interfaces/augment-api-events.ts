...
import type { FrameSupportDispatchDispatchInfo, FrameSupportTokensMiscBalanceStatus, PalletCreditcoinAddress, PalletCreditcoinAskOrder, PalletCreditcoinAskOrderId, PalletCreditcoinBidOrder, PalletCreditcoinBidOrderId, PalletCreditcoinCollectCoinsCollectedCoins, PalletCreditcoinCollectCoinsUnverifiedCollectedCoins, PalletCreditcoinDealOrder, PalletCreditcoinDealOrderId, PalletCreditcoinLegacySighash, PalletCreditcoinOcwErrorsVerificationFailureCause, PalletCreditcoinOffer, PalletCreditcoinOfferId, PalletCreditcoinTransfer, PalletImOnlineSr25519AppSr25519Public, PalletNominationPoolsCommissionChangeRate, PalletNominationPoolsPoolState, PalletStakingExposure, PalletStakingForcing, PalletStakingValidatorPrefs, SpConsensusGrandpaAppPublic, SpRuntimeDispatchError } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/events' {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    ...
    creditcoin: {
       ...
       **/
      CollectCoinsFailedVerification: AugmentedEvent<ApiType, [H256, PalletCreditcoinOcwErrorsVerificationFailureCause]>;
      /**
       * Collecting coins from Eth ERC-20 has been registered and will be verified.
       * [collected_coins_id, registered_collect_coins]
       **/
      CollectCoinsRegistered: AugmentedEvent<ApiType, [H256, PalletCreditcoinCollectCoinsUnverifiedCollectedCoins]>;
      /**
      ...
      TransferFailedVerification: AugmentedEvent<ApiType, [H256, PalletCreditcoinOcwErrorsVerificationFailureCause]>;
      /**
